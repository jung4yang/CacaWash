...
var shoot_delay_min = 3.0
var shoot_delay_max = 5.0

var shootingcount = 0.0
var bullet = preload("res://Scenes/Enemies/at_bubble.tscn")
...
func _ready():
	...
	#  2. CollisionShape2D 노드 참조 (충돌 모양 크기를 가져오기 위함)
	# 몬스터 씬의 자식 노드 구조에 따라 노드 이름을 확인하세요.
